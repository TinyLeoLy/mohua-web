			...
			<div class="case-item">
				...
				<div class="case-item-warper flex-row">
					...
					<div class="desc-box flex-column">
						...
						<div class="desc">
							本案例充分发挥农业农村部数据优势，针对大模型进行改造优化，在粮食安
							全、生猪稳产保供、乡村动态分析三个方向上训练行业大模型，实现粮食安
							全风险全流程的自主判决、实现乡村发展态势动态融合判断、实现生猪产业
							重点环节的及时预警，推进数据要素在农业农村相关领域的应用，为乡村振
							兴发展和现代农业建设提供大数据工具支撑。
						</div>
					</div>
				</div>
			...
			<div class="case-item">
				...
				<div class="case-item-warper flex-row">
					<div class="desc-box flex-column">
						...
						<img src="@/assets/images/case/line.png" alt="" />
						<div class="desc">
							本案例基于军事百科知识和其他内部私有数据，面向各类用户提供集成性、智能
							化的知识服务。主要功能包括交互式知识问答、摘要及文书生成、智能辅助决策
							等。
						</div>
					</div>
			...
			<div class="case-item">
				...
				<div class="case-item-warper flex-row">
					...
					<div class="desc-box flex-column">
						...
						<img src="@/assets/images/case/line.png" alt="" />
						<div class="desc">
							本案例面向作战仿真场景，利用大模型进行情报收集和分析、作战决策
							支持、目标识别和追踪、智能无人系统、生成打击方案、生成战损报告
							等。在实际场景中，极大地提升了实时决策的效率。
						</div>
					</div>
				</div>
			</div>
			<div class="case-item">
				...
				<div class="case-item-warper flex-row">
					<div class="desc-box flex-column">
						...
						<img src="@/assets/images/case/line.png" alt="" />
						<div class="desc">
							本案例面向水务场景，大模型通过识别用户对话，结合水环境知识，分析污染事
							件的关键要素、事件成因与本地流域分布、历史事件、地理地形、环境生态，追
							湖污染严重根因，结合污染治理知识体系，给出针对性的污染治理方案。
						</div>
					</div>
